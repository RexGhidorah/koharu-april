...
export const updateDocumentStyle = async (documentId: string,
    updateDocumentStyleRequest: UpdateDocumentStyleRequest, options?: RequestInit): Promise<UpdateDocumentStyleRequest> => {
...
export const getUpdateDocumentStyleMutationOptions = <TError = ApiError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateDocumentStyle>>, TError,{documentId: string;data: UpdateDocumentStyleRequest}, TContext>, request?: SecondParameter<typeof fetchApi>}
): UseMutationOptions<Awaited<ReturnType<typeof updateDocumentStyle>>, TError,{documentId: string;data: UpdateDocumentStyleRequest}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateDocumentStyle>>, {documentId: string;data: UpdateDocumentStyleRequest}> = (props) => {
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateDocumentStyleMutationResult = NonNullable<Awaited<ReturnType<typeof updateDocumentStyle>>>
    ...
    export const useUpdateDocumentStyle = <TError = ApiError,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateDocumentStyle>>, TError,{documentId: string;data: UpdateDocumentStyleRequest}, TContext>, request?: SecondParameter<typeof fetchApi>}
 , queryClient?: QueryClient): UseMutationResult<
...
export const deleteDocuments = async (
  ...
  return fetchApi<void>('/api/v1/documents', {
    ...options,
    method: 'DELETE',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(deleteDocumentsRequest),
  })
}
