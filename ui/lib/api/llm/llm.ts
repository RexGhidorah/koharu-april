...
export const getGetLlmCatalogQueryOptions = <TData = Awaited<ReturnType<typeof getLlmCatalog>>, TError = ApiError>( options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getLlmCatalog>>, TError, TData>>, request?: SecondParameter<typeof fetchApi>}
) => {
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetLlmCatalogQueryKey();
    ...
    const queryFn: QueryFunction<Awaited<ReturnType<typeof getLlmCatalog>>> = ({ signal }) => getLlmCatalog({ signal, ...requestOptions });





   return  { queryKey, queryFn,   gcTime: 300000, retry: 1,  ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getLlmCatalog>>, TError, TData> & { queryKey: DataTag<QueryKey, TData, TError> }
}
...
export function useGetLlmCatalog<TData = Awaited<ReturnType<typeof getLlmCatalog>>, TError = ApiError>(
  options: { query:Partial<UseQueryOptions<Awaited<ReturnType<typeof getLlmCatalog>>, TError, TData>> & Pick<
        DefinedInitialDataOptions<
...
export function useGetLlmCatalog<TData = Awaited<ReturnType<typeof getLlmCatalog>>, TError = ApiError>(
  options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof getLlmCatalog>>, TError, TData>>, request?: SecondParameter<typeof fetchApi>}
 , queryClient?: QueryClient
  ):  UseQueryResult<TData, TError> & { queryKey: DataTag<QueryKey, TData, TError> }
